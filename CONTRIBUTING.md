...
>
> A summary of the issue and the PHP version/OS environment in which it occurs.
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git remote add upstream https://github.com/it-akademy-students/intersession-2020-lipton-it
   ```
